...
function generateContent({rootDir, fullDir, siteName, packageName}) {
  ...
  const readPath = path.join(__dirname, `../../packages/${packageName}/docs`);
  const outputPath = path.join(__dirname, `../pages/${siteName === 'popmotion' ? '' : siteName}`);
