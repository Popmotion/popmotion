...
# "Out" easings are almost always the correct answer
...
![Sample of an Amiga demoscene intro](/static/guides/amiga-demoscene.png)
...
const Page = ({ section }) => (
  <ContentTemplate
    id="20170625-why-popmotion-default-easing-is-ease-out"
    section={section}
    category="undefined"
    title="In UI, 'out' easings are almost always the correct answer"
    description="'In-out' easings go home"
    published="30 Jun 17"
  >
    {content.tree}
  </ContentTemplate>
