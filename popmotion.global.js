...
var Role = function (methods) {
    ...
    each(methods, function (name, method) {
        role[name] = !__small$_35.isObj(method) ? method : __small$_35.copy(method);
    });
    ...
    */
    role.map = function (values) {
        ...
        return __small$_35.isString(values) ? this._map[values] || values : createRole(this, values);
    };
...
var each = __small$_35.each
    transformProps = __small$_64.props,
...
var cssRole = new __small$_28({
    _map: __small$_43,
    _typeMap: __small$_44,
    ...
    update: function (state, actor) {
        cssRole(actor.element, __small$_42(state, actor._cssCache));
    },
...
var each = __small$_35.each;
var camelToDash = __small$_35.camelToDash;
var transformProps = __small$_64.props;
...
exports = new __small$_28({
    _map: __small$_43,
    _typeMap: __small$_46,
    ...
    update: function (state) {
        var actor = this;
        each(__small$_45(state, this.svgOrigin), function (key, value) {
            __small$_15.set(actor.element, key, value);
        });
    }
...
/*
    Draw Path role
*/
var SVGDrawPath = new __small$_28({
    _map: __small$_47,
    ...
    */
    update: function (state) {
        __small$_15.update.call(this, createStyles(state, this.pathLength));
    }
});
...
var loop = {
    ...
    */
    frame: function () {
        __small$_67(function (framestamp) {
            if (isRunning) {
                loop.frame();
            }

            __small$_66.update(framestamp);
            isRunning = fireAll(framestamp, __small$_66.getElapsed());
        });
    },
...
var Process = (function () {
    ...
    */
    ...
    function Process(callback, scope) {
        ...
        // Set callback
        if (__small$_35.isFunc(callback)) {
            this.render = callback;
        } else if (__small$_35.isObj(callback)) {
            __small$_35.each(callback, function (key, value) {
                _this[key] = value;
            });
        }

        this.scope = __small$_35.isObj(scope) ? scope : this;

        this.setBackground(arguments[arguments.length - 1]);

        this.id = __small$_58.getProcessId();
        this.isActive = false;
    }
    ...
    Process.prototype.activate = function activate() {
        this.isActive = true;
        __small$_58.activate(this, this.id);
    };

    Process.prototype.deactivate = function deactivate() {
        this.isActive = false;
        __small$_58.deactivate(this.id);
    };
...
var 
    ...
    */
    distance: function (a, b) {
        return __small$_35.isNum(a) ? calc.distance1D(a, b) : calc.distance2D(a, b);
    },
    ...
    */
    offset: function (a, b) {
        ...
        __small$_35.each(b, function (key, value) {
            offset[key] = a.hasOwnProperty(key) ? value - a[key] : 0;
        });

        if (__small$_35.isNum(offset.x) && __small$_35.isNum(offset.y)) {
    ...
    */
    relativeValue: function (current, rel) {
        ...
        var _utils$splitValUnit = __small$_35.splitValUnit(equation[1]);
    ...
    */
    restricted: function (value, min, max) {
        if (__small$_35.isNum(min)) {
            value = Math.max(value, min);
        }

        if (__small$_35.isNum(max)) {
    ...
    */
    speedPerFrame: function (xps, frameDuration) {
        return __small$_35.isNum(xps) ? xps / (1000 / frameDuration) : 0;
    },
...
function checkValueType(existingValue, newValue, scope, valueName) {
    ...
    if (existingValue && existingValue.type) {
        ...
        // Finally run tests
        if (!valueType && __small$_35.isString(newValue.current)) {
            valueType = __small$_21.test(newValue.current);
        }
    }
...
function resolve(name, prop, value, scope) {
    ...
    // If function, resolve
    if (__small$_35.isFunc(prop) && isNumericalValue) {
        prop = prop.call(scope, scope);
    }

    // If string, check for relative numbers and units
    if (__small$_35.isString(prop)) {
        // If relative value
        if (prop.indexOf('=') > 0) {
            prop = __small$_34.relativeValue(value.current, prop);
        }
...
function split(name, value, scope, valueTypeHandler) {
    ...
    var _loop = function () {
        ...
        if (value.hasOwnProperty(propName)) {
            ...
            if (__small$_35.isFunc(valueProp)) {
                valueProp = valueProp.call(scope, scope);
            }

            if (!__small$_35.isString(valueProp)) {
                return 'continue';
            }
            ...
            each(splitProp, function (key, prop) {
                ...
                splitValues[key] = splitValues[key] || __small$_35.copy(__small$_21.defaultProps(value.type, key));
                splitValues[key][propName] = prop;

                if (__small$_35.isString(splitProp[key])) {
...
function splitUnit(property, hostValue) {
    if (__small$_35.isNum(property)) {
        return property;
    }
    var returnVal = property;

    var _utils$splitValUnit = __small$_35.splitValUnit(property);
...
function preprocess(existing, incoming, scope, defaultProp) {
    ...
    each(incoming, function (key, value) {
        ...
        if (newValue.type) {
            var typeHandler = __small$_21[newValue.type];
            ...
            if (typeHandler.split) {
                ...
                // Or just assign default properties for this value
                    ...
                    values[key] = __small$_35.merge(__small$_21.defaultProps(newValue.type, key), newValue);
                }
        }
    });
    ...
    */
    process: function (existing, incoming, inherit, defaultProp, scope) {
        ...
        each(preprocessed, function (key, value) {
            var newValue = existing[key] || __small$_35.copy(defaultValue),
            ...
            scope.updateOrder(key, __small$_35.has(newValue, 'watch'), hasChildren);
        });
...
var Action = (function () {
        ...
        if (props.values) {
            (function () {
                ...
                each(props.values, function (key, value) {
                    ...
                    currentValues[key] = existingValue ? __small$_35.merge(existingValue, newValue) : newValue;
                });
            })();
        }
    ...
    */
    ...
    Action.prototype.limit = function limit(output, value) {
        var restricted = __small$_34.restricted(output, value.min, value.max);
    ...
    */
    ...
    Action.prototype.extend = function extend(props) {
        ...
        return new this.constructor(__small$_35.merge(this, props), this.getDefaultValueProp());
    };
...
exports = Action;
//# sourceMappingURL=data:application/json;base64,
return exports;
})();
...
findMappedValue = function (newValue, linkedValue, toValue, mapLink, mapTo) {
    ...
    for (; i < mapLength; i++) {
        ...
        if (newValue < thisLinkValue || i === mapLength - 1) {
            newValue = __small$_34.value(__small$_34.restricted(__small$_34.progress(newValue, lastLinkValue, thisLinkValue), 0, 1), lastToValue, thisToValue);
            break;
        }
    }
...
;
;
var defaultAction = new __small$_29();
;
var watcher = new __small$_65();
...
exports = function (actor, framestamp, frameDuration) {
    ...
    for (var i = 0; i < numActiveValues; i++) {
        ...
        // Calculate new value
        var updatedValue = __small$_35.has(value, 'watch') ? watcher.process(actor, value) : action.process(actor, value, key, frameDuration);
        ...
        if (value.smooth) {
            updatedValue = __small$_34.smooth(updatedValue, value.current, frameDuration, value.smooth);
        }
        ...
        if (!action.calculatesVelocity) {
            value.velocity = __small$_34.speedPerSecond(value.frameChange, frameDuration);
        }
...
exports = function (actor) {
    ...
    for (var i = 0; i < numActiveParents; i++) {
        ...
        value.current = __small$_21[value.type].combine(actor.state[key], value.template);
...
var Actor = (function () {
    ...
    */
    ...
    function Actor() {
        ...
        var props = __small$_35.isString(opts) ? { element: opts } : opts;

        this.values = {};
        this.state = { values: {} };
        this.queue = new __small$_52();
        this.process = new __small$_26({ update: __small$_54, render: __small$_55, postRender: __small$_56 }, this);
        this.activeActions = {};
        this.numActive = 0;
        ...
        if (__small$_35.isString(props.element)) {
            props.element = __small$_53(props.element)[0];
        }
    ...
    */
    ...
    Actor.prototype.set = function set(opts) {
        ...
        if (opts && opts.values) {
            this.values = __small$_49.process(this.values, opts.values, opts, 'current', this);
        }
    ...
    */
    ...
    Actor.prototype.start = function start(toSet, input) {
        var actionExists = __small$_35.isNum(toSet);
    ...
    */
    ...
    Actor.prototype.sync = function sync() {
        ...
        __small$_35.each(this.values, function (key, value) {
            currentValues[key] = value.current;
        });

        this.start(new __small$_29({ values: currentValues }));
        return this;
    };
    ...
    Actor.prototype.assignRoles = function assignRoles(element, manualRoles, surpressInit) {
        ...
        if (!manualRoles && element) {
            ...
            // Or manually set if provided
                ...
                if (__small$_35.isArray(manualRoles)) {
    ...
    */
    ...
    Actor.prototype.autoAssignRoles = function autoAssignRoles(element) {
        ...
        if (element instanceof HTMLElement || element.tagName === 'svg') {
            this.roles.push(__small$_16);

            // Add SVG role if SVG element
        } else if (element instanceof SVGElement) {
                this.roles.push(__small$_17);

                // Add Draw Path role if path element
                if (element.tagName === 'path') {
                    this.roles.push(__small$_18);
                }
            }
    };
...
var Easing = function (x1, y1, x2, y2) {
    ...
    if (arguments.length > 1) {
        easingFunction = new __small$_59(x1, y1, x2, y2);
    } else {
...
__small$_35.each(baseEasing, function (key, baseEase) {
    var easingFunction = new __small$_27(baseEase);
...
function ease(progress, from, to, ease) {
    var progressLimited = __small$_34.restricted(progress, 0, 1);
    var easingFunction = __small$_35.isString(ease) ? __small$_32[ease] : ease;

    return __small$_34.valueEased(progressLimited, from, to, easingFunction);
};
...
var Tween = (function (_Action) {
    ...
    */
    ...
    Tween.prototype.process = function process(actor, value) {
        ...
        if (target !== undefined) {
            var progress = __small$_34.restricted(__small$_34.progress(this.elapsed - value.delay, 0, value.duration) - value.stagger, 0, 1);
            ...
            if (value.steps) {
                progress = __small$_35.stepProgress(progress, value.steps);
            }
    ...
    */
    ...
    Tween.prototype.checkNextStep = function checkNextStep(actor, name, method) {
        ...
        if (forever || __small$_35.isNum(step)) {
            ++count;
        ...
        each(this.values, function (key) {
            ...
            if (value.children) {
                each(value.children, function (childKey) {
                    __small$_49.flip(actorValues[key + childKey]);
                });
            }

            __small$_49.flip(value);
        });
    };
    ...
    Tween.prototype.restart = function restart() {
        ...
        this.started = __small$_35.currentTime();
    };
...
var Sequence = (function (_Actor) {
    ...
    Sequence.prototype.do = function _do(actor, action) {
        var isCallback = __small$_35.isFunc(actor);
    ...
    Sequence.prototype.stagger = function stagger(iterator, action, staggerProps) {
        ...
        var interval = __small$_35.isNum(staggerProps) ? staggerProps : staggerProps.interval || 100;
    ...
    Sequence.prototype.at = function at(timestamp) {
        if (__small$_35.isString(timestamp)) {
...
Input = function () {
    ...
    this.offset = {};
    this.velocity = {};
    this.history = new __small$_48();
    this.update(arguments[0], arguments[1]);

    if (__small$_35.isFunc(arguments[pollPos])) {
...
Input.prototype = {
    ...
    */
    update: function (arg0, arg1) {
        ...
        if (__small$_35.isNum(arg1)) {
            values[arg0] = arg1;
        } else {
            values = arg0;
        }

        this.history.add(__small$_35.merge(this.current, values));
    ...
    */
    onFrame: function (timestamp) {
        ...
        hasChanged = __small$_35.hasChanged(this.current, latest);

        // If input has changed between frames 
        if (hasChanged) {
            this.velocity = __small$_34.offset(this.current, latest);
            this.current = latest;
            this.inactiveFrames = 0;

            // Or it hasn't moved and our frame limit has been reached
        } else if (this.inactiveFrames >= this.maxInactiveFrames) {
                this.velocity = __small$_34.offset(this.current, this.current);
...
function generateCallback(method) {
    ...
    if (__small$_35.isString(method)) {
        callback = function (member) {
            return member[method].apply(member, args);
        };
    } else if (!__small$_35.isFunc(method)) {
        callback = function (member) {
...
var Iterator = (function () {
    ...
    Iterator.prototype.stagger = function stagger(method, props) {
        var tempMembers = __small$_35.copyArray(this.members);
        var numMembers = tempMembers.length;
        var propsIsInterval = __small$_35.isNum(props);
        ...
        this._stagger.start(new __small$_19(staggerProps));
...
var 
    speedPerFrame = __small$_34.speedPerFrame;
...
var simulations = {
    ...
    */
    velocity: function (value, duration) {
        var acceleration = __small$_35.isFunc(value.acceleration) ? value.acceleration() : value.acceleration;
    ...
    */
    glide: function (value, duration, started) {
        var timeUntilFinished = -__small$_35.currentTime() - started,
    ...
    */
    friction: function (value, duration) {
        ...
        return __small$_34.speedPerSecond(newVelocity, duration);
    },
...
var Simulate = (function (_Action) {
    ...
    */
    ...
    Simulate.prototype.process = function process(actor, value, key, timeSinceLastFrame) {
        ...
        var simulation = __small$_35.isString(simulate) ? __small$_51[simulate] : simulate;

        var newVelocity = simulation ? simulation(value, timeSinceLastFrame, this.started) : 0;

        value.velocity = Math.abs(newVelocity) >= value.stopSpeed ? newVelocity : 0;

        newValue = value.current + __small$_34.speedPerFrame(value.velocity, timeSinceLastFrame);
    ...
    */
    ...
    Simulate.prototype.limit = function limit(output, value) {
        ...
        if (isOutsideRange) {
            output = __small$_34.restricted(output, value.min, value.max);

            if (value.bounce) {
                value.velocity = __small$_51.bounce(value);
            } else if (value.capture) {
                __small$_51.capture(value, isOutsideMax ? value.max : value.min);
            }
        }
...
Pointer = function (e) {
    ...
    proto = Pointer.prototype = new __small$_24();
...
var Track = (function (_Action) {
    ...
    */
    ...
    Track.prototype.onFrameStart = function onFrameStart(actor, frameDuration, framestamp) {
        ...
        this.inputOffset = __small$_34.offset(this.inputOrigin, this.input.current);
    ...
    */
    ...
    Track.prototype.bindInput = function bindInput(input) {
        this.input = !input.current ? new __small$_61(input) : input;
...
exports = function (selector) {
    ...
    dom.forEach(function (element) {
        ...
        if (!actor) {
            ...
            actor = element[SAVE_PROP] = new __small$_22(opts);
        }

        actors.push(actor);
    });

    return actors.length > 1 ? new __small$_25(actors) : actors[0];
};
...
var 
    ...
    Sequence: __small$_23,

    Input: __small$_24,

    Iterator: __small$_25,
    ...
    */
    modifyEase: __small$_33,

    addValueType: function (types) {
        __small$_21.extend(types);
        return Popmotion;
    },
...
exports = function (value, terms) {
    var splitValue = {},
        numTerms = terms.length,
        colors = __small$_62(__small$_63(value)),
        i = 0;
...
exports = {
    ...
    defaultProps: {
        ...
        Saturation: __small$_39.percent,
        Lightness: __small$_39.percent,
        Alpha: __small$_39.opacity
    },
    ...
    split: function (value) {
        return __small$_37(value, terms);
    },

    combine: function (values) {
        return __small$_38(__small$_36(values, terms, ', ', 2), 'hsla');
    }
};
...
var 
    colorDefaults = __small$_39.color,
...
exports = {
    ...
    combine: function (values) {
        return __small$_38(__small$_36(values, terms, ', ', 2), 'rgba');
    }
};
...
exports = {
    ...
    defaultProps: __small$_7.defaultProps,
    ...
    combine: function (values) {
        return __small$_7.combine(values);
    }
};
...
var 
    supported = [__small$_7, __small$_6, __small$_8],
    numSupported = 3,
...
exports = {
    defaultProps: __small$_35.merge(__small$_7.defaultProps, __small$_6.defaultProps),

    test: function (value) {
        return __small$_7.test(value) || __small$_8.test(value) || __small$_6.test(value);
    },
    ...
    combine: function (values) {
        return values.Red !== undefined ? __small$_7.combine(values) : __small$_6.combine(values);
    }
};
...
exports = {
    ...
    */
    split: function (value) {
        var positions = __small$_41(value),
    ...
    combine: function (values) {
        return __small$_36(values, terms, ' ');
    }
};
...
exports = {
    ...
    */
    split: function (value) {
        var dimensions = __small$_41(value),
...
exports = {
    ...
    defaultProps: __small$_35.merge(__small$_9.defaultProps, {
        X: pxDefaults,
        Y: pxDefaults,
        Radius: pxDefaults,
        Spread: pxDefaults
    ...
    */
    split: function (value) {
        ...
        for (; i < numBits; i++) {
            ...
            if (hasReachedColor || __small$_9.test(thisBit)) {
        ...
        return __small$_35.merge(splitValue, __small$_9.split(colorProp));
    },

    combine: function (values) {
        return __small$_36(values, shadowTerms, ' ') + __small$_9.combine(values);
    }
};
...
exports = {
    test: function (value) {
        ...
        return __small$_35.isArray(matches) && matches.length > 1;
    },
...
__small$_2.addValueType({
    ...
    hex: __small$_8,
    color: __small$_9,
    positions: __small$_10,
    dimensions: __small$_11,
    scale: __small$_12,
    shadow: __small$_13,
    complex: __small$_14
});

__small$_2.attr = __small$_15;
__small$_2.css = __small$_16;
__small$_2.svg = __small$_17;
__small$_2.drawPath = __small$_18;
...
__small$_1.noConflict = function () {
    window.ui = UIref;
};

window.ui = window.popmotion = __small$_1;
...
//# sourceMappingURL=/Users/simon/git/popmotion/popmotion.global.js.map
