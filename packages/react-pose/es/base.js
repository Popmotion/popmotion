...
var PoseParentContext = /*#__PURE__*/createContext({});
...
var PoseElement = /*#__PURE__*/function (_super) {
    ...
    PoseElement.prototype.getInitialPose = function () {
        ...
        if (initialPose) {
            ...
            return Array.isArray(parentPose) ? parentPose.concat(thisPose, thisInternalPose) : [parentPose].concat(thisPose, thisInternalPose);
        }
    };
    ...
    PoseElement.prototype.getSetProps = function () {
        var _a = this.props,
            ...
            props = __rest(_a, ["children", "elementType", "poseConfig", "onChange", "onValueChange", "innerRef", "_pose", "pose", "initialPose", "onPoseComplete", "getParentPoseConfig", "registerChild", "onUnmount", "getInitialPoseFromParent", "popFromFlow", "values", "parentValues", "onDragStart", "onDragEnd"]);
    ...
    PoseElement.prototype.componentDidMount = function () {
        ...
        var config = __assign({}, poseConfig, { initialPose: this.getInitialPose(), values: values || poseConfig.values, parentValues: parentValues ? objectToMap(parentValues) : undefined, props: this.getSetProps(), onDragStart: onDragStart,
            onDragEnd: onDragEnd, onChange: onValueChange ? onValueChange : typeof onChange !== 'function' ? onChange : undefined });
    ...
    PoseElement.prototype.setPose = function (pose) {
        ...
        Promise.all(poseList.map(function (key) {
            ...
            return onPoseComplete && onPoseComplete();
        });
    };
...
var createComponentFactory = function (key) {
    var componentFactory = function (poseConfig) {
        ...
        return function (_a) {
            ...
            return !withParent || props.parentValues ? createElement(PoseElementComponent, __assign({ poseConfig: poseConfig, elementType: key }, props)) : createElement(PoseParentContext.Consumer, null, function (parentCtx) {
                return createElement(PoseElementComponent, __assign({ poseConfig: poseConfig, elementType: key }, props, parentCtx));
            });
        };
    };
...
var mergeChildren = function (_a) {
    var incomingChildren = _a.incomingChildren,
        displayedChildren = _a.displayedChildren,
        isLeaving = _a.isLeaving,
        removeFromTree = _a.removeFromTree,
    ...
    var entering = new Set(nextKeys.filter(function (key) {
        return isLeaving.has(key) || prevKeys.indexOf(key) === -1;
    }));
    entering.forEach(function (key) {
        return isLeaving.delete(key);
    });
    ...
    incomingChildren.forEach(function (child) {
        var newChildProps = entering.has(child.key) ? { initialPose: preEnterPose, _pose: enterPose } : moving.has(child.key) && flipMove ? { _pose: [enterPose, 'flip'] } : { _pose: enterPose };
        children.push(cloneElement$1(child, newChildProps));
    });
    leaving.forEach(function (key) {
        var child = displayedChildren.find(function (c) {
            return c.key === key;
        });
...
var handleIncomingChildren = function (props) {
    var displayedChildren = props.displayedChildren,
        incomingChildren = props.incomingChildren,
...
var PoseGroup = /*#__PURE__*/function (_super) {
