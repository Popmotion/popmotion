    ...
    ***************************************************************************** */
    ...
    var singleAxisPointer = function (axis) {
        return function (from) {
            return index$3((_a = {}, _a[axis] = from, _a)).pipe(function (v) {
                return v[axis];
            });
            var _a;
        };
    ...
    var animationLookup = /*#__PURE__*/new Map([['tween', tween], ['spring', index$2], ['decay', index$1], ['keyframes', keyframes], ['physics', index$1$1]]);
    var easeIn$1 = easing.easeIn,
        easeOut$1 = easing.easeOut,
        easeInOut$1 = easing.easeInOut,
        circIn$1 = easing.circIn,
        circOut$1 = easing.circOut,
        circInOut$1 = easing.circInOut,
        backIn$1 = easing.backIn,
        backOut$1 = easing.backOut,
        backInOut$1 = easing.backInOut,
        anticipate$1 = easing.anticipate;
    var easingLookup = /*#__PURE__*/new Map([['easeIn', easeIn$1], ['easeOut', easeOut$1], ['easeInOut', easeInOut$1], ['circIn', circIn$1], ['circOut', circOut$1], ['circInOut', circInOut$1], ['backIn', backIn$1], ['backOut', backOut$1], ['backInOut', backInOut$1], ['anticipate', anticipate$1]]);
    var getAction = function (v, _a, _b) {
        ...
        return animationLookup.get(type)(__assign$3({ from: from,
            to: to,
            velocity: velocity,
            ease: ease }, def));
    };
    ...
    var explicitlyFlipPose = function (state, nextPose) {
        ...
        var width = nextPose.width,
            ...
            remainingPose = __rest$1(nextPose, ["width", "height", "top", "left", "bottom", "right"]);
    ...
    var implicitlyFlipPose = function (state, nextPose) {
        ...
        return __assign$3({}, nextPose, flipPoseProps);
    };
    ...
    var createPoseConfig = function (element, _a) {
        var onDragStart = _a.onDragStart,
            ...
            dragBounds = _a.dragBounds,
            config = __rest$1(_a, ["onDragStart", "onDragEnd", "draggable", "dragBounds"]);
        var poseConfig = __assign$3({ flip: {} }, config, { props: __assign$3({}, config.props, { draggable: draggable,
        ...
        if (draggable) {
            var _b = dragPoses(draggable),
                ...
                dragEnd = _b.dragEnd;
            poseConfig.dragging = __assign$3({}, poseConfig.dragging, dragging);
            poseConfig.dragEnd = __assign$3({}, poseConfig.dragEnd, dragEnd);
        }
        return poseConfig;
    };
    var domPose = /*#__PURE__*/pose({
        ...
        extendAPI: function (api, _a, config) {
            ...
            var poserApi = __assign$3({}, api, { addChild: function (element, childConfig) {
