(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('popmotion-pose'), require('hey-listen')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'popmotion-pose', 'hey-listen'], factory) :
    (factory((global.pose = {}),global.React,null,null));
}(this, (function (exports,React,poseFactory,heyListen) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var PoseElement = (function (_super) {
        ...
        PoseElement.prototype.componentDidMount = function () {
            ...
            heyListen.warning(onChange === undefined || typeof onChange === 'function', 'The onChange prop is deprecated. Use onValueChange instead.');
            if (!registerChild) {
