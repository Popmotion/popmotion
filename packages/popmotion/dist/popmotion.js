(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('framesync'), require('style-value-types'), require('stylefire'), require('hey-listen')) :
    typeof define === 'function' && define.amd ? define(['exports', 'framesync', 'style-value-types', 'stylefire', 'hey-listen'], factory) :
    (factory((global.popmotion = {}),null,global.valueTypes,null,null));
}(this, (function (exports,framesync,styleValueTypes,styler,heyListen) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var convertToColorAction = function (init, props) { return (typeof props.from === 'string' && isColor(props.from) &&
        typeof props.to === 'string' && isColor(props.to)) ? init(__assign({}, props, { from: 0, to: 1 })).pipe(blendColor(props.from, props.to), styleValueTypes.color.transform)
        : init(props); };
