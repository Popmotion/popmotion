...
import { color, hsla, number } from 'style-value-types';
...
export { action, multicast, value, index as decay, keyframes, frame as everyFrame, index$1 as physics, index$2 as spring, timeline, tween, listen, index$3 as pointer, mouse, multitouch, chain, composite, crossfade, delay, merge, parallel$1 as parallel, schedule, stagger, calc, easing, transformers as transform, css, svg };
