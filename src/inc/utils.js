const protectedProperties = ['scope',  'dom'];
const CAMEL_CASE_PATTERN = /([a-z])([A-Z])/g;
const REPLACE_TEMPLATE = '$1-$2';
    
const isProtected = key => (protectedProperties.indexOf(key) !== -1);
...
const utils = {
    /*
        ...
        @return [string]
    */
    camelToDash: (string) => string.replace(CAMEL_CASE_PATTERN, REPLACE_TEMPLATE).toLowerCase(),
